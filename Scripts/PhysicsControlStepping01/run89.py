"""Reuse the foreground native input, runtime sample and continuous WGC runner."""
import json
import sys
from pathlib import Path
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / 'PhysicsControlBalance01'))
import run87
from client89 import work
run87.run68.OUT = Path(__file__).resolve().parents[2] / 'Saved/CombatSlice01/PhysicsControlStepping01/Worker'
