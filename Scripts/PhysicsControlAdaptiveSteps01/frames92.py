"""Extract unmodified timestamped frames from continuous WGC recordings."""
import sys
...
import av
name = sys.argv[1]
out = ROOT / 'Saved/CombatSlice01/PhysicsControlAdaptiveSteps01/Worker/Video'
dest = out / (name + '-Frames')
