"""Bootstrap only. All subsequent editor operations use official Epic MCP."""
...
try:
    ...
    result=r.run_command("exec(open('D:/devgames/MeridianSquad/Scripts/GASPALSLocomotion01/bootstrap.py').read())", unattended=True)
