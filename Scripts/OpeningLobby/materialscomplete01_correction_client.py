"""Foreground official Epic calls scoped to Correction01."""
import sys,json,time,types
from pathlib import Path
from functionalbuild01_client import call
OUT=Path(__file__).resolve().parents[2]/'Saved/OpeningLobby/MaterialsComplete01/Worker/Correction01'
def work(operation,argument=''):
    r=call('call_tool',dict(toolset_name='Game.Scripts.OpeningLobby.materialscomplete01_correction_tools.OpeningLobbyMaterialsCorrection01Tools',tool_name='action',arguments=dict(operation=operation,argument=argument)))
