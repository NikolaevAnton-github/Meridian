...
@u.uclass()
class OpeningLobbyPainterMetal01Tools(u.ToolsetDefinition):
    @toolset_registry.tool_call
    @staticmethod
    def action(operation: str, argument: str = '') -> str:
        """Operate only on the new PainterMetal01 assets and bounded source reads."""
        import paintermetal01_unreal as work
...
registration=Registration([OpeningLobbyPainterMetal01Tools])
