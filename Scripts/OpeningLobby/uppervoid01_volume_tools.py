...
@u.uclass()
class OpeningLobbyUpperVoid01VolumeTools(u.ToolsetDefinition):
    @toolset_registry.tool_call
    @staticmethod
    def action(operation:str,argument:str)->str:
        import uppervoid01_volume_unreal as work
...
registration=Registration([OpeningLobbyUpperVoid01VolumeTools])
