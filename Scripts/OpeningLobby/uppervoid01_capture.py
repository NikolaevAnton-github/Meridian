...
import types,json
from uppervoid01_unreal import ROOT,OUT,MAP,SOURCE,guard,write,settings
p=ROOT/'Scripts/OpeningLobby/paintermetal01_capture.py'
s=p.read_text().replace('from paintermetal01_unreal import','from uppervoid01_unreal import')
...
base.cap.VIEWS={'entrance-axis-90':(-1850,0,0,10),'inner-axis-90':(1850,0,180,10),
 'east-aisle-90':(-1150,980,0,12),'west-aisle-90':(1150,-980,180,12),
