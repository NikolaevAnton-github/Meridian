...
OUT=Path(__file__).resolve().parents[2]/'Saved/OpeningLobby/PainterFloor01/Worker'

def work(operation,argument=''):
    result=call('call_tool',dict(toolset_name='Game.Scripts.OpeningLobby.painterfloor01_tools.OpeningLobbyPainterFloor01Tools',
