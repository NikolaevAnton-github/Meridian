...
OUT=Path(__file__).resolve().parents[2]/'Saved/OpeningLobby/UpperVoid01/HeightCorrection03/Worker'
def work(operation,argument=''):
    r=call('call_tool',dict(toolset_name='Game.Scripts.OpeningLobby.uppervoid01_volume_tools.OpeningLobbyUpperVoid01VolumeTools',tool_name='action',arguments=dict(operation=operation,argument=argument)))
