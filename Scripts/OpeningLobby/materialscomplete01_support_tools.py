"""Temporary support toolset on the official Epic MCP registry."""
import importlib,json,traceback
import unreal as u
import toolset_registry
from toolset_registry.registration import Registration
@u.uclass()
class OpeningLobbyMaterialsSupport02Tools(u.ToolsetDefinition):
    @toolset_registry.tool_call
    @staticmethod
    def action(operation:str,argument:str='')->str:
        import materialscomplete01_support_unreal as work
...
registration=Registration([OpeningLobbyMaterialsSupport02Tools])
