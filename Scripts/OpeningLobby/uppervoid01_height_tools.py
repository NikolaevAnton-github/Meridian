...
@u.uclass()
class OpeningLobbyUpperVoid01HeightTools(u.ToolsetDefinition):
    @toolset_registry.tool_call
    @staticmethod
    def action(operation:str,argument:str)->str:
        import uppervoid01_height_unreal as work
...
registration=Registration([OpeningLobbyUpperVoid01HeightTools])
