...
@u.uclass()
class OpeningLobbyMaterialsComplete01Tools(u.ToolsetDefinition):
    @toolset_registry.tool_call
    @staticmethod
    def action(operation: str, argument: str = '') -> str:
        """Operate only on the new MaterialsComplete01 assets and bounded source reads."""
        import materialscomplete01_unreal as work
...
registration=Registration([OpeningLobbyMaterialsComplete01Tools])
