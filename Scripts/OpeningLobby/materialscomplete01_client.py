...
OUT=Path(__file__).resolve().parents[2]/'Saved/OpeningLobby/MaterialsComplete01/Worker'

def work(operation,argument=''):
    result=call('call_tool',dict(toolset_name='Game.Scripts.OpeningLobby.materialscomplete01_tools.OpeningLobbyMaterialsComplete01Tools',
