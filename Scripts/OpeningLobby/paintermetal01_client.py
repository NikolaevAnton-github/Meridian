...
OUT=Path(__file__).resolve().parents[2]/'Saved/OpeningLobby/PainterMetal01/Worker'

def work(operation,argument=''):
    result=call('call_tool',dict(toolset_name='Game.Scripts.OpeningLobby.paintermetal01_tools.OpeningLobbyPainterMetal01Tools',
