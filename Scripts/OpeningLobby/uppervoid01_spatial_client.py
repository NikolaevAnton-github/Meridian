...
OUT=Path(__file__).resolve().parents[2]/'Saved/OpeningLobby/UpperVoid01/HeightCorrection04/Worker'
def work(operation,argument=''):
    r=call('call_tool',dict(toolset_name='Game.Scripts.OpeningLobby.uppervoid01_spatial_tools.OpeningLobbyUpperVoid01SpatialTools',tool_name='action',arguments=dict(operation=operation,argument=argument)))
