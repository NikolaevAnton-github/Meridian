...
import types
import unreal as u
from paintermetal01_unreal import ROOT,OUT,SOURCE,MAP,guard,write,settings
...
cap=types.ModuleType('paintermetal01_existing_capture')
exec(compile(source,str(ROOT/'Scripts/OpeningLobby/reworka01_capture.py'),'exec'),cap.__dict__)
cap.VIEWS={'entrance-90':(-1850,0,0,-6),'inner-90':(1850,0,180,-6),'checkpoint-metal-90':(-1690,170,198,-12),'service-door-90':(-1710,925,165,-6),'elevator-metal-90':(2620,-170,22,0)}
active=None
